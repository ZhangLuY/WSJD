...
/**
 * XtglWhcd entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XTGL_WHCD", schema = "CXJM")
public class XtglWhcd implements java.io.Serializable {
	...
	/** minimal constructor */
	public XtglWhcd(String CBh) {
		this.CBh = CBh;
	}

	/** full constructor */
	public XtglWhcd(String CBh, String VMc, String VBz, String VCode,
