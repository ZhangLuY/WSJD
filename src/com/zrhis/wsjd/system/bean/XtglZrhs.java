...
/**
 * XtglZrhs entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "XTGL_ZRHS", schema = "CXJM", uniqueConstraints = @UniqueConstraint(columnNames = {
		"DEP_ID", "C_BH" }))
public class XtglZrhs implements java.io.Serializable {
	...
	/** minimal constructor */
	public XtglZrhs(String VId, String depId, String CBh) {
		this.VId = VId;
		this.depId = depId;
		this.CBh = CBh;
	}
	...
	/** full constructor */
	public XtglZrhs(String VId, String depId, String CBh, String VMc,
